...
| exact-candidate-full-stack-promotion | in_progress | Candidate implementation, focused tests, Pages build/smoke, browser reachability and a 176-capture desktop/tablet/mobile dark/light evidence matrix are green. Immutable staging, direct-main publication, Pages provenance, and exact-SHA server dispatch remain in the release wave. |
