...
| community-stats-release-proof | in-progress | Local proof is green, including full runtime/core/simulation/UI gates and eight hash-bound rendered captures. Exact-candidate commit, staging/API deployment, live CORS/cache/freshness checks, production verification and rollback receipt remain. |
