...
| hosted-performance-evidence | implemented | stable staging exact candidate 14/14,public entry route median desktop LCP 272ms INP 24ms CLS 0.0151,mobile LCP 300ms INP 16ms CLS 0.0085,direct game-shell hydration retained separately as a red diagnostic |
| release-receipt-authority | implemented | release-authority focused suite 5/5,one exact deployable candidate 1cfc8774 plus artifact 9d1b585e across staging, visual and performance receipts,production verifier intentionally remains pending until direct-main publication |
