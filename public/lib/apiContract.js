...
const SUCCESS_SHAPES = Object.freeze({
  ...
  "GET /api/facilities": { required: ["ok", "teamId", "year", "cash", "allowance", "facilities"] },
  "POST /api/facilities/invest": { required: ["ok", "facility", "from", "to", "cost", "state"] },
