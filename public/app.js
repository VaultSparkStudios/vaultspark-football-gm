    ...
    runAction(async () => {
      ...
      const payload = await api("/api/settings", {
        ...
        body: {
          ...
          hallOfFameInductionScoreMin: Number(document.getElementById("settingHallOfFameInductionScoreMin").value || 450),
          hallOfFameMaxClassSize: Number(document.getElementById("settingHallOfFameMaxClassSize")?.value || 6),
