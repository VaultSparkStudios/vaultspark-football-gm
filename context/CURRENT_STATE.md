...
- 2026-06-07: verification passed for focused helper/protocol tests, `npm run test:studio`, `npm run test:runtime`, `npm run test:core`, `npm run build:pages`, and `npm run smoke:pages`; default full-suite sim shards were not rerun because this pass did not touch engine simulation behavior
